...
#Max values
#print("The availability the Critical Path is:")
#for ps in range(6):
#   print("Prod.Station#"+str(ps+1)+" :", B[0,ps])
...
f.write("The Critical Path response is: ")
f.close();
...
for ps in range(6):
    n=B[0,ps]+29
    n1=round(n,2)
    w=" PS #"+str(ps+1)+" " + str(n1)
    f.write(w)
f.close();

#AI by Example, Chapters 1 to 3
